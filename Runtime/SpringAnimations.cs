...
namespace Motion
{
    ...
    {
        protected override Matrix4x4 Add(Matrix4x4 a, Matrix4x4 b) => MatrixUtils.Add(a, b);

        protected override Matrix4x4 Subtract(Matrix4x4 a, Matrix4x4 b) => MatrixUtils.Subtract(a, b);

        protected override Matrix4x4 Multiply(Matrix4x4 a, float b) => MatrixUtils.Multiply(a, b);
