...
namespace Motion
{
    public class IntTween : TweenAnimation<int>
    {
        ...
        protected override int GetVelocity(int a, int b, float dt) => Mathf.RoundToInt((b - a) / dt);
    }
    ...
    public class FloatTween : TweenAnimation<float>
    {
        ...
        protected override float GetVelocity(float a, float b, float dt) => (b - a) / dt;
    }
    ...
    public class Vector2Tween : TweenAnimation<Vector2>
    {
        ...
        protected override Vector2 GetVelocity(Vector2 a, Vector2 b, float dt) => (b - a) / dt;
    }
    ...
    public class Vector3Tween : TweenAnimation<Vector3>
    {
        ...
        protected override Vector3 GetVelocity(Vector3 a, Vector3 b, float dt) => (b - a) / dt;
    }
    ...
    public class Vector4Tween : TweenAnimation<Vector4>
    {
        ...
        protected override Vector4 GetVelocity(Vector4 a, Vector4 b, float dt) => (b - a) / dt;
    }
    ...
    public class ColorTween : TweenAnimation<Color>
    {
        ...
        protected override Color GetVelocity(Color a, Color b, float dt) => (b - a) / dt;
    }
    ...
    public class QuaternionTween : TweenAnimation<Quaternion>
    {
        ...
        // TODO
        // protected override Quaternion GetVelocity(Quaternion a, Quaternion b, float dt) => (b - a) / dt;
        protected override Quaternion GetVelocity(Quaternion a, Quaternion b, float dt) => Quaternion.identity;
    }
    ...
    public class MatrixTween : TweenAnimation<Matrix4x4>
    {
        ...
        // TODO
        // protected override Matrix4x4 GetVelocity(Matrix4x4 a, Matrix4x4 b, float dt) => (b - a) / dt;
        protected override Matrix4x4 GetVelocity(Matrix4x4 a, Matrix4x4 b, float dt) => Matrix4x4.zero;
    }
}